...
function FounderNarrative({ founder }: { founder: FounderId }) {
  const text: Record<FounderId, string> = {
    ...
    hamilton:
      "Hamilton ties Madison for the bottom of the composite under the strict Shakespeare-only standard. He is rank 6 on the use of Shakespeare-coined phrases and on the verified-references column (zero on both). His 1779 letter calling General Lee 'a little spice of the Julius Caesar or Cromwell' was treated as a Shakespeare exception in an earlier version of the project; the revised methodology sets it aside as a historical-Caesar reference (paired with Cromwell, a non-Shakespeare figure), not a play allusion.",
    madison:
      "Madison ties Hamilton for the bottom of the composite. He is rank 6 on six of the eleven methods. His one quiet outlier is the use of Shakespeare-coined phrases (rank 3), where a small number of widely-shared phrases lift him momentarily out of last place.",
  };
  return (
